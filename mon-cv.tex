...
% profile picture
\cvprofilepic{FortySecondsCV/pics/profile.png}
% logo picture
\cvlogopic{FortySecondsCV/pics/logo_txt.png}
...
\addtofrontsidebar{
	...
	\sidesection{Languages}
		\pointskill{\flag{FortySecondsCV/pics/flags/flat/CN.png}}{Chinese}{5}
		\pointskill{\flag{FortySecondsCV/pics/flags/flat/DE.png}}{German}{3}
	\pointskill{\flag{FortySecondsCV/pics/flags/flat/GB.png}}{English}{3}
	\pointskill{\flag{FortySecondsCV/pics/flags/flat/FR.png}}{French}{3}
...
\addtobacksidebar{
	...
	\begin{memberships}
		\membership[4em]{FortySecondsCV/pics/logo.png}{PandaScience.net}
		\membership[4em]{FortySecondsCV/pics/logo.png}{Some longer text spanning over more than
			only one line}
	\end{memberships}
}
